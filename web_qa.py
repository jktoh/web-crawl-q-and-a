...
@app.get("/get-hyperlinks")
# Function to get the hyperlinks from a URL
def get_hyperlinks(url: str = full_url):
...
@app.get("/get-domain-hyperlinks")
# Function to get the hyperlinks from a URL that are within the same domain
def get_domain_hyperlinks(local_domain: str = domain, url: str = full_url):
    clean_links = []
...
async def remove_newlines(serie):
...
### Step 6
################################################################################
@app.get("/convert-text-to-csv")
async def convert_text_to_csv(domain: str = domain):
...
async def tokenize(df: dict):
    ...
    # df.n_tokens.hist()
    return df.drop(columns="title").to_dict()
################################################################################
### Step 8
################################################################################
...
@app.get("/split-into-many")
async def split_into_many(text: str, max_tokens: int = max_tokens):
